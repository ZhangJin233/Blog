 ...
 **异常** ： 当这个事情发生的时候，原本打算要接着做的事情不能再继续了，必须得要停下来，让其他地方的某段代码来处理。
...
```java
  ...
  System.err.printIn("an exception throw");
  throw e;
}
```
...
**捕捉任何异常**
  ...
  System.err.printLn("catught an exception");
}
